...
export function SessionDetail({ session, jobs, onSelectJob }: Props) {
  ...
  return (
    <div class="detail session-detail">
      <header class="detail__header">
        ...
        {session.derived && <span class="badge badge--derived">derived (no manifest)</span>}
      </header>
