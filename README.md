...
| `--destination URI` | | Remote archive URI for `--publish`. Defaults to `QMB_REMOTE_ARCHIVE_URI`, `~/.qmb/config.toml`, or `gs://data-platform-moises-temp/qmb/`. |
...
Default destination: `gs://data-platform-moises-temp/qmb/`.
